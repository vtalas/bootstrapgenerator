...
using bootstrapgenerator.Controllers;
using cms.Code.Bootstraper.DataRepository;
using log4net;

namespace bootstrapgenerator.Code.Bootstraper.DataRepository
{
	public class BootstrapDataRepositoryImpl : BootstrapDataRepository
	{
		static readonly ILog Log = LogManager.GetLogger(typeof(BootstrapDataRepositoryImpl));
